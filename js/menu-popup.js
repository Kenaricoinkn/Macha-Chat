...
if (menuBtn && menuPopup) {
  menuPopup.innerHTML = `
    ...
    <div class="menu-grid">
      <div class="menu-item">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9.75 12 4l9 5.75V20a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1V9.75z"/>
        </svg>
        <span>Beranda</span>
      </div>
      <div class="menu-item">
  ...
  backMenu.addEventListener('click', () => menuPopup.classList.remove('active'));
